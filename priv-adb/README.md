...
This module owns Wireless Debugging pairing/connect plus execution of the shared server launch command generated by `priv-runtime`.
...
It must not own the shared native starter executable, or become a public ADB command library, shell helper API, or Android system operation wrapper.

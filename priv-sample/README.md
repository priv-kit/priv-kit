...
- A sample Shizuku UserService starter that runs the shared Priv Kit shell start command, then immediately destroys the Shizuku UserService while the app waits for the privileged server handoff.

...
internal class Spake25519Context private constructor(
    ...
    private fun transcriptHash(sharedEncoded: ByteArray, theirMsg: ByteArray): ByteArray {
        val sha = MessageDigest.getInstance(SHA512_ALGORITHM)
    ...
    companion object {
        ...
        // Fixed SPAKE2 mask points used by ADB's BoringSSL-compatible pairing flow.
        private const val M_POINT_HEX = "5ada7e4bf6ddd9adb6626d32131c6b5c51a1e347a3478f53cfcf441b88eed12e"
        private const val N_POINT_HEX = "10e3df0ae37d8e7a99b5fe74b44672103dbddcbd06af680d71329a11693bc778"
        private val M_POINT = checkNotNull(Ed25519.decode(Ed25519.hex(M_POINT_HEX)))
        private val N_POINT = checkNotNull(Ed25519.decode(Ed25519.hex(N_POINT_HEX)))
        ...
        fun create(
            ...
            val passwordHash = MessageDigest.getInstance(SHA512_ALGORITHM).digest(password)
